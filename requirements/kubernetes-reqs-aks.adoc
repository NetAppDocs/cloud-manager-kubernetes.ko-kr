...
* https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-azure.html["Cloud Manager에서 커넥터를 생성합니다"^] (권장)
* https://docs.netapp.com/us-en/cloud-manager-connector/task-launching-azure-mktp.html["Azure Marketplace에서 Connector를 생성합니다"^]
